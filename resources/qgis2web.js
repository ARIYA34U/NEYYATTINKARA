...
map.getView().fit([8564296.792608, 925470.683087, 8592866.657646, 941364.063972], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAP OF NEYYATTINKARA TALUK</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (200 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map shows the significant informations about Neyyattinkara taluk including Drainage, Road Network, Railway Line, Geomorphology and important Junctions. Important place are also added with images.';
            }
